...
$body =  <<<HTML
  ...
  <div class="pt-3 mx-5 pb-5">
    ...
    <div class="w-100 text-center"><a class="btn btn-primary my-2" href="$lang/guides/hackless/">Hackless Guide</a></div>
    ...
    <div class="w-100 text-center"><a class="btn btn-primary my-2" href="$lang/guides/homebrew/">Homebrew Guide</a></div>
    ...
    <div class="w-100 text-center"><a class="btn btn-primary my-2" href="$lang/guides/usbloading/">USB Loading Guide</a></div>
